...
document.write('<script src="' + bootPATH + 'core.js" type="text/javascript"></script>');
...
//toastr
document.write('<script src="' + bootPATH + 'toastr.min.js" type="text/javascript"></script>');
document.write('<link href="' + bootPATH + 'toastr.min.css" rel="stylesheet" type="text/css" />');

//common
document.write('<link href="' + bootPATH + 'common.css" rel="stylesheet" type="text/css" />');
